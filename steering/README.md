...
| [wrangler-deploy-env.md](wrangler-deploy-env.md) | wrangler 는 CLOUDFLARE_ACCOUNT_ID/CLOUDFLARE_API_TOKEN 을 읽음(CF_* 아님). .env 의 CF_* 매핑은 `bash scripts/cf-env.sh <cmd>` 래퍼로 — 배포·시크릿·원격 D1 마이그레이션. | convention, deploy, cloudflare, wrangler, pitfall | 2026-06-14 | 1 |
