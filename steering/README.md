...
| [gh-pr-edit-projectcards-bug.md](gh-pr-edit-projectcards-bug.md) | `gh pr edit`이 Projects classic deprecated GraphQL(projectCards) 오류로 실패하면, 본문 수정은 `gh api -X PATCH /repos/<o>/<r>/pulls/<n> --input <json>`으로 우회. | pitfall, github, gh-cli | 2026-06-15 | 2 |
